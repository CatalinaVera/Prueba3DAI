...
if (isset($_POST['ReservaSitio2']))
{
	   $lista = $modeloRsit -> ListarResit();
       $sitio = new Reserva_sitio(2, $_POST['txtRun'], $_POST['txtLlegada'],$_POST['txtSalida'],1);
       $hoy = date("Y-m-d"); 
...
if (isset($_POST['ReservaSitio3']))
{
	   $lista = $modeloRsit -> ListarResit();
       $sitio = new Reserva_sitio(3, $_POST['txtRun'], $_POST['txtLlegada'],$_POST['txtSalida'],1);
       $hoy = date("Y-m-d"); 
...
if (isset($_POST['ReservaSitio4']))
{
	   $lista = $modeloRsit -> ListarResit();
       $sitio = new Reserva_sitio(4, $_POST['txtRun'], $_POST['txtLlegada'],$_POST['txtSalida'],1);
       $hoy = date("Y-m-d"); 
...
if (isset($_POST['ReservaSitio5']))
{
	   $lista = $modeloRsit -> ListarResit();
       $sitio = new Reserva_sitio(5, $_POST['txtRun'], $_POST['txtLlegada'],$_POST['txtSalida'],1);
       $hoy = date("Y-m-d"); 
...
if (isset($_POST['ReservaSitio6']))
{
	   $lista = $modeloRsit -> ListarResit();
       $sitio = new Reserva_sitio(6, $_POST['txtRun'], $_POST['txtLlegada'],$_POST['txtSalida'],1);
       $hoy = date("Y-m-d"); 
